...
const faqs = [
  ...
  {
    question: "¿Cómo funciona la integración con Dt Dental?",
    answer: "La integración es nativa. Desde tu interfaz de Dt Dental podrás ofrecer financiamiento con un clic, ver el estado de las solicitudes y recibir notificaciones de aprobación. El onboarding toma menos de 24 horas.",
  },
  {
